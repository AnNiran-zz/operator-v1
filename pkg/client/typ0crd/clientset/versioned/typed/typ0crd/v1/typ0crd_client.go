...
import (
	...
	"operator-v1/pkg/client/typ0crd/clientset/versioned/scheme"
...
// CrdV1Client is used to interact with features provided by the crd.devcluster.com group.
type CrdV1Client struct {
	restClient rest.Interface
}

func (c *CrdV1Client) Typ0crds(namespace string) Typ0crdInterface {
	return newTyp0crds(c, namespace)
}
